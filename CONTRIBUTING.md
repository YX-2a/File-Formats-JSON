...
4. If a file type has multiple extensions, you can write them in separate JSON objects inside the array.
...
these rules above have to be followed carefully in order to preserve the stylistic cohesion of the file and any unjustified violation will not be tolerated.